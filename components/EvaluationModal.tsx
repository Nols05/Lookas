  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="p-6 max-h-[80vh] overflow-y-auto">
        <h2 className="text-2xl font-semibold mb-4 border-b pb-2">Image Evaluation Result</h2>
        ...
        <div className="mt-8 pt-4 border-t flex justify-end">
          <button
            onClick={handleClose}
            className="px-5 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition text-sm font-medium"
          >
            Close
          </button>
        </div>
